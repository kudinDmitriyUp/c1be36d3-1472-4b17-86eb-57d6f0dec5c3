...
export const metadata: Metadata = {
  title: "Sofia di Bella - Premium Insurance Office Rome",
  description: "Expert insurance solutions from LUISS-educated professional. Multilingual insurance advisor offering life, business, and international coverage.",
  keywords: "insurance Rome, life insurance, business insurance, international coverage",
  openGraph: {
    title: "Sofia di Bella Insurance - Premium Solutions",
    description: "Expert insurance guidance for families and businesses",
    siteName: "Sofia di Bella Insurance"
  }
};
